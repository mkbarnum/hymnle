...
import { PracticeStatsModal } from "./PracticsStatsModal";
...
import { addStatsForCompletedPractice, loadPracticeStats } from "./practiceStats";
import {
...
type PracticePageProps = {
    ...
    setIsSongModalOpen: (value: boolean) => void;
...
const PracticePage = ({
    ...
    // Load practice stats from localStorage or set defaults
    ...
    useEffect(() => {
        saveGameStateToLocalStorage({ mode: "practice", guesses, solution });
    }, [guesses]);
    ...
    const onEnter = () => {
        ...
        if (hymn && currentTurn <= MAX_CHALLENGES && !isGameWon) {
            ...
            if (winningSong) {
                setStats(addStatsForCompletedPractice(stats, guesses.length + 1));
                setIsGameWon(true);
    ...
    const onSkip = () => {
        ...
        setGuesses((prevGuesses) => {
            ...
            if (updatedGuesses.length === MAX_CHALLENGES) {
                setStats(addStatsForCompletedPractice(stats, updatedGuesses.length));
                setIsGameLost(true);
                showErrorAlert(CORRECT_SONG_MESSAGE(solution), { persist: true, delayMs: 500 });
            }
        ...
        <div className="h-screen flex flex-col">
            <div className="pt-2 px-1 pb-8 md:max-w-7xl w-full mx-auto sm:px-6 lg:px-8 flex flex-col grow">
                ...
                <PracticeStatsModal
                    ...
                    guesses={guesses}
                    gameStats={stats} // Use practiceStats instead of gameStats
